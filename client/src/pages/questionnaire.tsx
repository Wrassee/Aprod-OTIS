...
import { WideMeasurementInput, getAllMeasurementValues } from '@/components/wide-measurement-input';
      ...
      <main className="max-w-7xl mx-auto px-6 py-8" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="mb-8">
          ...
          {(currentQuestions as Question[]).length > 0 && (currentQuestions as Question[]).every((q: Question) => q.type === 'true_false') ? (
            ...
            /* Check if current group has measurement questions - use WideMeasurementInput */
