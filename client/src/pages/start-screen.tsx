...
export function StartScreen({ onLanguageSelect }: StartScreenProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      {/* Slogan */}
      <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-16 text-center tracking-wide leading-relaxed" style={{ fontFamily: '"Crimson Text", "Libre Baskerville", "Times New Roman", serif' }}>
        Made to move you™
      </h1>
