...
interface MegaWideMeasurementProps {
  question: QuestionConfig;
  value?: number | string;
  onValueChange: (value: string) => void;
}

export function MegaWideMeasurement({ question, value, onValueChange }: MegaWideMeasurementProps) {
  ...
  const handleValueChange = (val: string) => {
    console.log(`Stable input typing: ${question.id} = ${val}`);
